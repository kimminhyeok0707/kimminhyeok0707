...
* **역할:** 백엔드 셋업, 데이터베이스 설계 및 실시간 위치 공유 기술 연구
* **Tech:** Spring Boot, PostgreSQL, Render

#### 🌐 Web Server Development
* **설명:** QA를 거쳐 완성도를 높인 웹 서버 구축 프로젝트
* **역할:** 서버 아키텍처 설계 및 데이터 관리

#### 💾 Database System Design
* **설명:** PostgreSQL을 활용한 효율적인 데이터 구조 설계
* **Key Point:** `miliroad_y2xr` 프로젝트 등의 DB 연결 및 관리 경험
